...
CREATE TABLE "usuario" (
                            ...
                            "role" varchar(50) NOT NULL
                                check ( "role" IN ('admin', 'instituicao', 'empresa', 'estudante', 'outro') ),
                            "uf" char(2) NOT NULL,
...
CREATE TABLE "inscricao" (
                             ...
                             CONSTRAINT fk_oportunidade FOREIGN KEY ("id_oportunidade") REFERENCES "oportunidade" ("uuid")
);
